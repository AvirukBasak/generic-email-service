...
export const RateLimits = {
  MemeImages: {
    POST: (uid: Nullable<string>, req: NextApiRequest, res: NextApiResponse): Promise<boolean> =>
      rateLimiter(5, uid, "MemeImages.POST", req, res),
    GET: (uid: Nullable<string>, req: NextApiRequest, res: NextApiResponse): Promise<boolean> =>
      rateLimiter(60, uid, "MemeImages.GET", req, res),
    PATCH: (uid: Nullable<string>, req: NextApiRequest, res: NextApiResponse): Promise<boolean> =>
      rateLimiter(5, uid, "MemeImages.PATCH", req, res),
  },
  ...
  // Logging
  Logs: {
    POST: (req: NextApiRequest, res: NextApiResponse): Promise<boolean> => rateLimiter(60, null, "LOG_WRITE", req, res),
  },
};
